...
public class BlockRenderBase implements ISimpleBlockRenderingHandler 
{
	...
	protected RenderColour getRenderColor(int metadata){ return null; }
	...
	protected final void renderInventoryCuboid(Block block, int meta, RenderBlocks renderer){
		...
		RenderColour color = getRenderColor(meta);
		if(color != null){
