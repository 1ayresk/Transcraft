...
public class TranscrafterModel extends ModelBase
{
  ...
  public TranscrafterModel()
  {
    ...
    textureHeight = 128;
      ...
      Top_bit_2.setTextureSize(64, 256);
      ...
      Top_bit_3.setTextureSize(64, 256);
      ...
      Top_bit_4.setTextureSize(64, 256);
      ...
      Floaty_part.setTextureSize(64, 256);
