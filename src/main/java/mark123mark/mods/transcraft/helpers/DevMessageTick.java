...
public class DevMessageTick implements ITickHandler {
	...
	public void tickEnd(EnumSet<TickType> type, Object... tickData) {
		...
		{
				minecraft.fontRenderer.drawString("This is a dev version of Transcraft!", 0, height - 50, 10);
				minecraft.fontRenderer.drawString("If anyting breaks or crashes please report it on the Github!", 0, height - 40, 10);
