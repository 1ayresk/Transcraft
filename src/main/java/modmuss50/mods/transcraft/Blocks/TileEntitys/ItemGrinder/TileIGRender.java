...
public class TileIGRender extends TileEntitySpecialRenderer {
	 ...
	 * double, float)
	 * 
	 * @Override public void renderTileEntityAt(TileEntity par1TileEC, double
	 * par2, double par4, double par6, float par8) { int i;
	 * 
	 * if (!par1TileEC.func_145830_o()) { i = 0; } else { Block block =
	 * par1TileEC.func_145838_q(); i = par1TileEC.func_145832_p();
	 * 
	 * if (block instanceof ItemGrinder && i == 0) { i =
	 * par1TileEC.func_145832_p(); }
	 * 
	 * }
	 * 
	 ...
	 * 
	 * GL11.glPushMatrix(); GL11.glEnable(GL12.GL_RESCALE_NORMAL);
	 * GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F); GL11.glTranslatef((float) par2,
	 * (float) par4 + 1.0F, (float) par6 + 1.0F); GL11.glScalef(1.0F, -1.0F,
	 * -1.0F); GL11.glTranslatef(0.5F, 0.5F, 0.5F); short short1 = 0;
	 * 
	 * if (i == 2) { short1 = 180; }
	 * 
	 * if (i == 3) { short1 = 0; }
	 ...
	 * 
	 * modelchest.renderAll(); GL11.glDisable(GL12.GL_RESCALE_NORMAL);
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
		...
		// this.func_147500_a((ItemGrinderTile) par1TileEntity, par2, par4,
		// par6, par8);
	}
