...
public class TranscraftFluids {
	 ...
	 * 
	 * 
	 * public static void init() { registerFluids(); initializeLiquids();
	 * initializeContainers(); registerBlocks(); registerItems(); }
	 * 
	 ...
	 * 
	 * private static void initializeLiquids() { Fluids.LiquidTransmutter =
	 * Optional.of(new BlockFluidLiquidTransmuter(
	 ...
	 * 
	 * Fluids.ItemBucketLiquidTrasnmutter = Optional .of((new
	 * ItemBucketLiquidTrasnmutter(
	 ...
	 * Fluids.ItemBucketLiquidTrasnmutter.get(), 1, 1), new
	 * ItemStack(Fluids.ItemBucketLiquidTrasnmutter.get(), 1, 0)); }
	 * 
	 ...
	 * 
	 * LanguageRegistry.instance().addStringLocalization(Fluids.
	 * ItemBucketLiquidTrasnmutter.get().getUnlocalizedName(new
	 * ItemStack(Fluids.ItemBucketLiquidTrasnmutter.get().itemID, 1, 1)) +
	 * ".name","Transmutter Bucket " + "\u00a72Liquid Transmutter");
	 * LanguageRegistry
	 * .instance().addStringLocalization(Fluids.ItemBucketLiquidTrasnmutter
	 * .get().getUnlocalizedName(new
	 * ItemStack(Fluids.ItemBucketLiquidTrasnmutter.get().itemID, 1, 0)) +
	 * ".name","Transmutter Bucket"); }
	 * 
