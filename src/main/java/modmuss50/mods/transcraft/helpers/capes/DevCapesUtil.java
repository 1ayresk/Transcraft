...
/**
 * Wraps methods from DevCapes so it does not crash due to client-only class
 * references. Use this class to add a file URL instead of DevCapes to avoid a
 * crash when starting a server.
 * 
 * @author Jadar
 */
