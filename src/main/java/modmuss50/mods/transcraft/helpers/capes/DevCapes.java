...
/**
 * This library adds capes for people you specify. Use DevCapesUtil to add your
 * capes if you do not call the addFileUrl method in a client proxy.
 * 
 * @author Jadar
 */
public class DevCapes {
	...
	/**
	 * <b>DO NOT CALL THIS UNLESS YOU KNOW IT IS BEING CALLED FROM A CLIENT ONLY
	 * CLASS/METHOD!</b><br>
						...
						if (line.charAt(i) == '=') {
							...
							if (subLine.startsWith("http")) {
								...
								ResourceLocation r = new ResourceLocation(
										"DevCapes/" + group);
								ThreadDownloadImageData t = makeDownloadThread(
										r, capeUrl, null,
	 ...
	 * @param parResource
	 */
	public void addDownloadThread(String parGroup,
			ThreadDownloadImageData parResource) {
	...
	/**
	 * Used to download images. Copied from AbstractClientPlayer to remove a
	 * conditional.
	 * 
