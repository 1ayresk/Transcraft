...
public class DevCapesImageBufferDownload implements IImageBuffer {
	...
	public BufferedImage parseUserSkin(BufferedImage par1BufferedImage) {
		if (par1BufferedImage == null) {
			...
			int imageWidth = (par1BufferedImage.getWidth(null) <= 64) ? 64
					: (par1BufferedImage.getWidth(null));
			int imageHeight = (par1BufferedImage.getHeight(null) <= 32) ? 32
					: (par1BufferedImage.getHeight(null));
