...
public class LoadLang {
	...
	public static void loadlang() {
		...
		ColouredNamesUtil.addColourLocalizationsForBlock(
				(ItemBlock) new ItemStack(TranscraftBlocks.enderQuartzBlock, 1)
						.getItem(), "Ender Quartz");

		ColouredNamesUtil.addColourLocalizationsForBlock(
				(ItemBlock) new ItemStack(TranscraftBlocks.CutenderQuartz, 1)
						.getItem(), "Chiseled Ender Quartz");

		ColouredNamesUtil.addColourLocalizationsForBlock(
				(ItemBlock) new ItemStack(TranscraftBlocks.EnderQuartzBrick, 1)
						.getItem(), "Ender Quartz Brick");

		ColouredNamesUtil.addColourLocalizationsForBlock(
				(ItemBlock) new ItemStack(TranscraftBlocks.EnderQuartzBigBrick,
						1).getItem(), "Ender Quartz Big Brick");

		ColouredNamesUtil.addColourLocalizationsForBlock(
				(ItemBlock) new ItemStack(TranscraftBlocks.ThinClearGlass, 1)
						.getItem(), "Thin Crystal Glass");

		ColouredNamesUtil
				.addColourLocalizationsForBlock((ItemBlock) new ItemStack(
						TranscraftBlocks.FancyCrystalGlass, 1).getItem(),
						"Fancy Crystal Glass");

		ColouredNamesUtil.addColourLocalizationsForBlock(
				(ItemBlock) new ItemStack(TranscraftBlocks.ClearGlass, 1)
						.getItem(), "Crystal Glass");
