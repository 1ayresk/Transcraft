...
public class TranspediaGui extends GuiContainer {
	...
	public void initGui() {
		 ...
		 * 100, 20, 20, "<")); this.field_146292_n.add(new GuiButton(0,
		 * 48,field_147009_r / 2 + 100, 20, 20, ">"));
		 */
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2,
		 ...
		 * 
		 * 
		 * GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F); field_110421_t = new
		 ...
		 * (this.field_146295_m - this.field_147000_g) / 2;
		 * this.drawTexturedModalRect(k, l, 0, 0,
		 * this.field_146999_f,this.field_147000_g);
		 * 
		 * if (pageNumber != 0) { drawPlayerModel(k + 162, l + 80, 30, (float)
		 * (k + 162)- this.xSize_lo, (float) (l + 60 - 30) -
