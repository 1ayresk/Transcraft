...
public class TranscraftFMP {// implements IPartFactory {
	...
	public static void registerBlocks() {
		 ...
		 * BlockMicroMaterial.createAndRegister( TranscraftBlocks.TranscraftOre,
		 * i); }
		 * 
		 ...
		 * BlockMicroMaterial
		 * .createAndRegister(TranscraftBlocks.DriedTransmutter);
		 * BlockMicroMaterial
	 ...
	 * 
	 * 
	 * @Override public TMultiPart createPart(String arg0, boolean arg1) { //
