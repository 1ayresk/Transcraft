		...
		for (int i = 15; i >= 0; i--) {
			if (shouldUseMetaFromMiddle) {
				GameRegistry.addShapelessRecipe(
						new ItemStack(itemStack.getItem(), 1, i),
						new ItemStack(middle.getItem(), 1, i), new ItemStack(
								Items.dye, 1, i),
						new ItemStack(Items.dye, 1, i));
			} else {
				GameRegistry.addShapelessRecipe(
						new ItemStack(itemStack.getItem(), 1, i),
						new ItemStack(middle.getItem(), 1, middle
								.getItemDamage()), new ItemStack(Items.dye, 1,
								i), new ItemStack(Items.dye, 1, i));
			}
		}
	}
